    ...
    <div className="relative h-screen bg-gradient-to-b lg:h-[140vh]">
      ...
      <main className="relative pl-4 pb-24 lg:space-y-24 lg:pl-16">
        ...
        <section className="md:space-y-24">
          ...
          {/* My List */}
          <Category title="Comedies" movies={comedyMovies}></Category>
          <Category title="Scary Movies" movies={horrorMovies}></Category>
          <Category title="Romance Movies" movies={romanceMovies}></Category>
